from ml_prod_deployment.tasks.sample_etl_task import SampleETLTask
from ml_prod_deployment.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/ml-prod-deployment/sample_experiment"
    }
